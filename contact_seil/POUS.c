void MY_PROGRAM_init__(MY_PROGRAM *data__, BOOL retain) {
  ...
  __INIT_VAR(data__->OR13_OUT,__BOOL_LITERAL(FALSE),retain)
...
void MY_PROGRAM_body__(MY_PROGRAM *data__) {
  ...
  __SET_VAR(data__->,OR13_OUT,,OR__BOOL__BOOL(
    (BOOL)__BOOL_LITERAL(TRUE),
    NULL,
    (UINT)2,
    (BOOL)__GET_LOCATED(data__->INICIAR,),
    (BOOL)__GET_LOCATED(data__->LAMP,)));
  __SET_VAR(data__->,NOT14_OUT,,!(__GET_LOCATED(data__->PARAR,)));
  __SET_VAR(data__->,AND15_OUT,,AND__BOOL__BOOL(
    (BOOL)__BOOL_LITERAL(TRUE),
    NULL,
    (UINT)2,
    (BOOL)__GET_VAR(data__->OR13_OUT,),
    (BOOL)__GET_VAR(data__->NOT14_OUT,)));
